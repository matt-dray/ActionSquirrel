...
{ActionSquirrel} is an R package containing a (very work-in-progress) interactive audio-visual experience ('game') in the R console, powered by [{R6}](https://r6.r-lib.org/). 
